    ...
    <body>
        ...
        <div class="content">
            ...
            <div style="background: #1a1a2e; border-radius: 8px; padding: 20px; margin: 20px 0; text-align: center;">
                ...
                <a href="https://admin-workbons.preview.emergentagent.com" style="background: #F5A623; color: #1a1a2e; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; display: inline-block;">
                    🔗 Open Smart-TS App
                </a>
