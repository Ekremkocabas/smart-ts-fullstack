...
const styles = StyleSheet.create({
  ...
  usageValue: { color: '#1A1A2E', fontSize: 14, fontWeight: '600' },
  ...
  planName: { fontSize: 16, fontWeight: '700', color: '#1A1A2E', marginBottom: 4 },
  planPrice: { fontSize: 28, fontWeight: '800', color: '#1A1A2E' },
  ...
  tableHeaderCell: { fontWeight: '700', color: '#1A1A2E' },
