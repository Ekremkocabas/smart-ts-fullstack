...
const styles = StyleSheet.create({
  ...
  periodLabel: { fontSize: 16, fontWeight: '700', color: '#fff', minWidth: 160, textAlign: 'center' },
  statsRow: {
    flexDirection: 'row',
    paddingHorizontal: 16,
    gap: 8,
  ...
  werknemerNaam: { color: '#fff', fontSize: 16, fontWeight: '600' },
  ...
  totalBadgeLabel: { color: '#a0a0a0', fontSize: 10 },
  werfRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingVertical: 5,
  ...
  werfNaam: { flex: 1, color: '#a0a0a0', fontSize: 13 },
  werfUren: { color: '#fff', fontSize: 13, fontWeight: '600' },
});
