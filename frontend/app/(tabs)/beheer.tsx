            ...
            {werknemers.filter(w => w.rol !== 'admin').map((werknemer) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Ionicons name="person" size={20} color={werknemer.actief ? "#22C55E" : "#6c757d"} />
                    <View>
          ...
          <View style={styles.tabContent}>
              ...
              <TouchableOpacity style={styles.logoUploadBtn} onPress={pickLogo}>
                {logoBase64 ? (
                  ...
                  <View style={styles.logoUploadContent}>
                    <Ionicons name="image-outline" size={32} color="#22C55E" />
            ...
            <View style={styles.toggleRow}>
              <View style={styles.toggleInfo}>
                <Ionicons name="camera" size={18} color="#22C55E" style={{ marginRight: 8 }} />
                <View style={{ flex: 1 }}>
            ...
            <View style={styles.toggleRow}>
              <View style={styles.toggleInfo}>
                <Ionicons name="mail" size={18} color="#22C55E" style={{ marginRight: 8 }} />
                <View style={{ flex: 1 }}>
...
const styles = StyleSheet.create({
  ...
  adminBadge: { backgroundColor: '#22C55E', paddingHorizontal: 12, paddingVertical: 4, borderRadius: 12 },
  ...
  noAccessText: { fontSize: 20, fontWeight: '600', color: '#0F172A', marginTop: 16 },
  ...
  activeTab: { backgroundColor: '#22C55E', borderColor: '#22C55E' },
  tabText: { color: '#6c757d', fontSize: 13, fontWeight: '500' },
  activeTabText: { color: '#000' },
  content: { flex: 1 },
  tabContent: { padding: 16 },
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  sectionTitle: { fontSize: 20, fontWeight: '600', color: '#0F172A', marginBottom: 12 },
  ...
  noticeBold: { color: '#22C55E', fontWeight: '600' },
  ...
  overviewStatValue: { color: '#0F172A', fontSize: 22, fontWeight: '700' },
  ...
  weekMiniBadgeText: { color: '#0F172A', fontSize: 12, fontWeight: '600' },
  ...
  statusVerzonden: { backgroundColor: '#22C55E' },
  ...
  listItemText: { color: '#0F172A', fontSize: 16, fontWeight: '500' },
  textInactive: { color: '#6c757d' },
  listItemSubtext: { color: '#6c757d', fontSize: 12, marginTop: 2 },
  teamBadge: { color: '#22C55E', fontSize: 11, marginTop: 4, backgroundColor: 'rgba(245, 166, 35, 0.1)', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 4, overflow: 'hidden' },
  uurtariefText: { color: '#22C55E', fontSize: 12, fontWeight: '600', marginTop: 2 },
  ...
  textInput: { backgroundColor: '#FFFFFF', borderRadius: 12, padding: 16, color: '#0F172A', fontSize: 16, borderWidth: 1, borderColor: '#E8E9ED' },
  inputDisabled: { opacity: 0.5 },
  textArea: { minHeight: 120, textAlignVertical: 'top' },
  textAreaSmall: { minHeight: 80, textAlignVertical: 'top' },
  helpText: { color: '#6c757d', fontSize: 12, marginTop: 4 },
  saveButton: { backgroundColor: '#22C55E', padding: 16, borderRadius: 12, alignItems: 'center', marginTop: 8 },
  ...
  logoUploadText: { color: '#22C55E', fontSize: 16, fontWeight: '600' },
  ...
  resultTitle: { fontSize: 22, fontWeight: 'bold', color: '#0F172A', marginBottom: 8 },
  ...
  passwordValue: { color: '#22C55E', fontSize: 24, fontWeight: 'bold', letterSpacing: 2 },
  ...
  resultButton: { backgroundColor: '#22C55E', paddingVertical: 14, paddingHorizontal: 40, borderRadius: 12 },
