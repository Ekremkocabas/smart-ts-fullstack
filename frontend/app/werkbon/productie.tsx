...
const styles = StyleSheet.create({
  ...
  productNumber: { fontSize: 14, fontWeight: '600', color: '#22C55E' },
  ...
  pickerTextSmall: { fontSize: 13, color: '#0F172A' },
  inputSmall: { 
    backgroundColor: '#fff', 
    borderRadius: 8, 
    padding: 10, 
  ...
  productSummaryTitle: { fontSize: 14, fontWeight: '600', color: '#0F172A', marginBottom: 4 },
