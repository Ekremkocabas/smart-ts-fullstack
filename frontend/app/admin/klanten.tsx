                ...
                <View style={styles.section}>
                  ...
                  {formData.prijsmodel === 'vaste_prijs' && (
                    <>
                      ...
                      <TextInput style={styles.input} value={formData.standaard_vaste_prijs ? String(formData.standaard_vaste_prijs) : ''} onChangeText={(v) => setFormData({ ...formData, standaard_vaste_prijs: parseFloat(v) || 0 })} placeholder="5000.00" placeholderTextColor="#6c757d" keyboardType="decimal-pad" />
                    </>
                  )}
