...
export default function WerkbonDetail() {
  ...
  const getStatusInfo = (status: string) => {
    switch (status) {
      ...
      case 'verzonden': return { color: theme.primaryColor || '#22C55E', label: 'Verzonden', icon: 'send' };
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={[styles.title, { color: theme.secondaryColor || '#0F172A' }]}>Werkbon niet gevonden</Text>
        </View>
      </View>
    );
  }
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <Text style={[styles.title, { color: theme.secondaryColor || '#0F172A' }]}>Werkbon details</Text>
        ...
        <View style={styles.headerActions}>
          ...
          <TouchableOpacity style={[styles.emailBtn, { backgroundColor: theme.primaryColor || '#22C55E' }]} onPress={resendEmail} disabled={sending}>
      ...
      <View style={styles.statusCard}>
        ...
        <View style={[styles.weekBadge, { backgroundColor: `${theme.primaryColor || '#22C55E'}20` }]}>
          <Text style={[styles.weekText, { color: theme.primaryColor || '#22C55E' }]}>Week {werkbon.week_nummer}</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.overviewGrid}>
          ...
          <View style={styles.overviewCard}>
            <Ionicons name="timer" size={24} color={theme.primaryColor || '#22C55E'} />
      ...
      {/* Uren Tabel */}
      <View style={styles.section}>
        <Text style={[styles.sectionTitle, { color: theme.secondaryColor || '#0F172A' }]}>Uren per dag</Text>
          ...
          {werkbon.uren?.map((uren, index) => {
            ...
            return (
              <View key={index} style={[styles.tableRow, index % 2 === 0 && styles.tableRowAlt]}>
                ...
                <Text style={[styles.tableCell, { fontWeight: '600', color: theme.primaryColor || '#22C55E' }]}>{rowTotal}</Text>
              </View>
            );
          })}
      ...
      {/* Handtekening */}
      <View style={styles.section}>
        <Text style={[styles.sectionTitle, { color: theme.secondaryColor || '#0F172A' }]}>Handtekening</Text>
      ...
      {werkbon.foto_data && (
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: theme.secondaryColor || '#0F172A' }]}>Foto</Text>
      ...
      {werkbon.opmerkingen && (
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: theme.secondaryColor || '#0F172A' }]}>Opmerkingen</Text>
      ...
      <View style={styles.actionsSection}>
        <TouchableOpacity style={[styles.actionBtn, { backgroundColor: theme.primaryColor || '#22C55E' }]} onPress={downloadPdf} disabled={downloading}>
          <Ionicons name="download" size={20} color="#fff" />
          <Text style={styles.actionBtnText}>{downloading ? 'Bezig...' : 'PDF downloaden'}</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.actionBtn, styles.actionBtnSecondary, { backgroundColor: `${theme.primaryColor || '#22C55E'}20` }]} onPress={resendEmail} disabled={sending}>
          <Ionicons name="mail" size={20} color={theme.primaryColor || '#22C55E'} />
          <Text style={[styles.actionBtnText, { color: theme.primaryColor || '#22C55E' }]}>{sending ? 'Bezig...' : 'Opnieuw verzenden'}</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
...
const styles = StyleSheet.create({
  ...
  emailBtn: { width: 44, height: 44, borderRadius: 12, backgroundColor: '#22C55E', alignItems: 'center', justifyContent: 'center' },
  ...
  weekBadge: { backgroundColor: '#22C55E20', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 },
  weekText: { fontSize: 14, fontWeight: '600', color: '#22C55E' },
  ...
  overviewValue: { fontSize: 15, fontWeight: '600', color: '#0F172A', marginTop: 4 },
  ...
  tableCell: { flex: 1, fontSize: 14, color: '#0F172A', textAlign: 'center' },
  ...
  signatureName: { fontSize: 15, fontWeight: '500', color: '#0F172A', marginBottom: 8 },
  ...
  opmerkingenText: { fontSize: 14, color: '#0F172A', lineHeight: 22 },
  actionsSection: { flexDirection: 'row', gap: 12, marginBottom: 40 },
  actionBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#22C55E', paddingVertical: 16, borderRadius: 12 },
  actionBtnSecondary: { backgroundColor: '#22C55E20' },
