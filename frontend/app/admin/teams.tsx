  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.header}>
        <View>
          <Text style={[styles.title, { color: theme.secondaryColor || '#0F172A' }]}>Teams</Text>
                ...
                <View style={styles.tableCell}>
                  {t.ploegbaas ? (
                    <View style={[styles.ploegbaasBadge, { backgroundColor: `${theme.primaryColor || '#22C55E'}20` }]}>
                      <Ionicons name="star" size={12} color={theme.primaryColor || '#22C55E'} />
                      <Text style={[styles.ploegbaasText, { color: theme.primaryColor || '#22C55E' }]}>{t.ploegbaas}</Text>
                    </View>
                  ) : (
...
const styles = StyleSheet.create({
  ...
  teamName: { fontSize: 15, fontWeight: '600', color: '#0F172A' },
  ploegbaasBadge: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#22C55E20', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 6, alignSelf: 'flex-start' },
  ploegbaasText: { fontSize: 13, color: '#22C55E', fontWeight: '500' },
