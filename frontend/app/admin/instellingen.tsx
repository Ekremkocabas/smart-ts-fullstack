...
export default function InstellingenAdmin() {
  ...
  const [tempColor, setTempColor] = useState('#22C55E');
...
const styles = StyleSheet.create({
  ...
  colorLabel: { fontSize: 14, fontWeight: '600', color: '#0F172A' },
  ...
  hexInput: { flex: 1, backgroundColor: '#F5F6FA', borderRadius: 10, padding: 14, fontSize: 16, color: '#0F172A', borderWidth: 1, borderColor: '#E8E9ED' },
  ...
  presetColorActive: { borderColor: '#0F172A' },
