  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View>
          <Text style={[styles.title, { color: theme.secondaryColor || '#0F172A' }]}>Berichten</Text>
      ...
      <View style={styles.tabsContainer}>
        <View style={styles.tabs}>
          <TouchableOpacity
            style={[styles.tab, activeTab === 'werknemers' && styles.tabActive, activeTab === 'werknemers' && { borderBottomColor: theme.primaryColor || '#22C55E' }]}
            onPress={() => setActiveTab('werknemers')}
          >
            <Ionicons name="people" size={18} color={activeTab === 'werknemers' ? (theme.primaryColor || '#22C55E') : '#6c757d'} />
            <Text style={[styles.tabText, activeTab === 'werknemers' && styles.tabTextActive]}>
              Werknemers
            </Text>
            <View style={[styles.tabBadge, activeTab === 'werknemers' && styles.tabBadgeActive, activeTab === 'werknemers' && { backgroundColor: `${theme.primaryColor || '#22C55E'}20` }]}>
              <Text style={[styles.tabBadgeText, activeTab === 'werknemers' && styles.tabBadgeTextActive, activeTab === 'werknemers' && { color: theme.primaryColor || '#22C55E' }]}>
          ...
          <TouchableOpacity
            style={[styles.tab, activeTab === 'onderaannemers' && styles.tabActive, activeTab === 'onderaannemers' && { borderBottomColor: theme.primaryColor || '#22C55E' }]}
            onPress={() => setActiveTab('onderaannemers')}
          >
            <Ionicons name="construct" size={18} color={activeTab === 'onderaannemers' ? (theme.primaryColor || '#22C55E') : '#6c757d'} />
            <Text style={[styles.tabText, activeTab === 'onderaannemers' && styles.tabTextActive]}>
              Onderaannemers
            </Text>
            <View style={[styles.tabBadge, activeTab === 'onderaannemers' && styles.tabBadgeActive, activeTab === 'onderaannemers' && { backgroundColor: `${theme.primaryColor || '#22C55E'}20` }]}>
              <Text style={[styles.tabBadgeText, activeTab === 'onderaannemers' && styles.tabBadgeTextActive, activeTab === 'onderaannemers' && { color: theme.primaryColor || '#22C55E' }]}>
          ...
          <TouchableOpacity
            style={[styles.tab, activeTab === 'archief' && styles.tabActive, activeTab === 'archief' && { borderBottomColor: theme.primaryColor || '#22C55E' }]}
            onPress={() => setActiveTab('archief')}
          >
            <Ionicons name="archive" size={18} color={activeTab === 'archief' ? (theme.primaryColor || '#22C55E') : '#6c757d'} />
          ...
          <TouchableOpacity
            style={[styles.tab, activeTab === 'per_werknemer' && styles.tabActive, activeTab === 'per_werknemer' && { borderBottomColor: theme.primaryColor || '#22C55E' }]}
            onPress={() => { setActiveTab('per_werknemer'); setSelectedWerknemer(null); }}
          >
            <Ionicons name="folder-open" size={18} color={activeTab === 'per_werknemer' ? (theme.primaryColor || '#22C55E') : '#6c757d'} />
          ...
          <TouchableOpacity
            style={[styles.tab, activeTab === 'mappen' && styles.tabActive, activeTab === 'mappen' && { borderBottomColor: theme.primaryColor || '#22C55E' }]}
            onPress={() => { setActiveTab('mappen'); setMappenWerknemer(null); setMappenDocs([]); }}
          >
            <Ionicons name="folder" size={18} color={activeTab === 'mappen' ? (theme.primaryColor || '#22C55E') : '#6c757d'} />
          ...
          <View style={styles.werknemerListPanel}>
            ...
            <ScrollView style={styles.werknemerScroll}>
              {werknemers.filter(w => w.actief).map((wn) => (
                <TouchableOpacity
                  key={wn.id}
                  style={[styles.werknemerItem, mappenWerknemer?.id === wn.id && styles.werknemerItemActive, mappenWerknemer?.id === wn.id && { backgroundColor: `${theme.primaryColor || '#22C55E'}10`, borderLeftColor: theme.primaryColor || '#22C55E' }]}
                    ...
                    {mappenDocs.length === 0 ? (
                      ...
                      <View key={doc.id} style={[styles.messageCard, { flexDirection: 'row', alignItems: 'center' }]}>
                        <Ionicons
                          ...
                          size={24} color={theme.primaryColor || '#22C55E'}
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      selectedWerknemer?.id === wn.id && { backgroundColor: `${theme.primaryColor || '#22C55E'}10`, borderLeftColor: theme.primaryColor || '#22C55E' }
                    ]}
              ...
              {filteredBerichten.map((bericht, berichtIndex) => (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    bericht.vastgepind && { backgroundColor: `${theme.primaryColor || '#22C55E'}08` },
                ...
                >
                  ...
                  <View style={styles.messageHeader}>
                    ...
                    <View style={styles.messageBadges}>
                      {bericht.vastgepind && (
                        <View style={[styles.pinBadge, { backgroundColor: `${theme.primaryColor || '#22C55E'}20` }]}>
                          <Ionicons name="pin" size={12} color={theme.primaryColor || '#22C55E'} />
                        </View>
                      )}
                      {bericht.is_broadcast && (
                        <View style={styles.broadcastBadge}>
          ...
          {selectedBericht ? (
            <ScrollView style={styles.detailScroll}>
              ...
              <View style={styles.detailActions}>
                <TouchableOpacity
                  style={[styles.actionBtn, { backgroundColor: `${theme.primaryColor || '#22C55E'}20` }]}
                  onPress={() => togglePin(selectedBericht)}
                >
                  <Ionicons name={selectedBericht.vastgepind ? 'pin' : 'pin-outline'} size={18} color={theme.primaryColor || '#22C55E'} />
                  <Text style={[styles.actionBtnText, { color: theme.primaryColor || '#22C55E' }]}>
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalBody}>
              ...
              <View style={styles.optionsRow}>
                ...
                >
                  <Ionicons name="pin" size={18} color={form.vastgepind ? (theme.primaryColor || '#22C55E') : '#6c757d'} />
                  <Text style={[styles.optionText, form.vastgepind && styles.optionTextActive, form.vastgepind && { color: theme.primaryColor || '#22C55E' }]}>Vastpinnen</Text>
                </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  tabBadgeActive: { backgroundColor: '#22C55E20' },
  tabBadgeText: { fontSize: 12, color: '#6c757d', fontWeight: '600' },
  tabBadgeTextActive: { color: '#22C55E' },
  ...
  messageCardPinned: { backgroundColor: '#22C55E08' },
  ...
  senderName: { fontSize: 14, fontWeight: '600', color: '#0F172A' },
  messageTime: { fontSize: 12, color: '#6c757d' },
  messageBadges: { flexDirection: 'row', gap: 6 },
  pinBadge: { padding: 4, backgroundColor: '#22C55E20', borderRadius: 4 },
  ...
  messageSubject: { fontSize: 15, fontWeight: '600', color: '#0F172A', marginBottom: 4 },
  ...
  detailSubject: { fontSize: 24, fontWeight: '700', color: '#0F172A', marginBottom: 12 },
  detailMeta: { gap: 6 },
  detailFrom: { fontSize: 14, color: '#0F172A' },
  ...
  detailText: { fontSize: 15, color: '#0F172A', lineHeight: 24 },
  detailAttachments: { backgroundColor: '#F5F6FA', borderRadius: 12, padding: 16, marginBottom: 24 },
  attachmentsTitle: { fontSize: 14, fontWeight: '600', color: '#0F172A', marginBottom: 12 },
  ...
  recipientName: { flex: 1, fontSize: 14, color: '#0F172A' },
  ...
  attachmentFileName: { flex: 1, fontSize: 13, color: '#0F172A' },
  ...
  panelTitle: { fontSize: 16, fontWeight: '600', color: '#0F172A', padding: 16, borderBottomWidth: 1, borderBottomColor: '#E8E9ED' },
  ...
  werknemerItemActive: { backgroundColor: '#22C55E10', borderLeftWidth: 3, borderLeftColor: '#22C55E' },
  ...
  werknemerName: { fontSize: 14, fontWeight: '600', color: '#0F172A' },
  ...
  selectedWerknemerName: { fontSize: 18, fontWeight: '600', color: '#0F172A' },
